...
- `result.coef()`: returns named coefficient estimates
- `result.confint()`: returns named confidence intervals
- `result.summary()`: prints the main table plus confidence intervals
